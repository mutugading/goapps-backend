...
SELECT
    ...
    '[{"label":"Current Month EBITDA","value_field":"display_value","agg":"sum","compare":"MoM","format":"currency_thousands","show_sparkline":true,"sparkline_periods":12},
      {"label":"YTD EBITDA","value_field":"display_value","agg":"sum","compare":"YTD_vs_LY","format":"currency_thousands"},
      {"label":"L12M Total","value_field":"display_value","agg":"sum","compare":"none","format":"currency_thousands"}]'::jsonb,
...
SELECT
    ...
    '{"secondary_charts":[{"title":"Net Profit vs EBITDA","chart_type":"line","chart_config":{"x_axis_field":"period","y_axis_field":"display_value"},"span":"half"},{"title":"Monthly Detail","chart_type":"data_table","span":"half"}]}'::jsonb,
    '["MoM","YoY","YTD","R12"]'::jsonb,
    '[{"label":"Current Month Net Profit","value_field":"display_value","agg":"sum","compare":"MoM","format":"currency_thousands","show_sparkline":true,"sparkline_periods":12},
      {"label":"Net Profit Margin","value_field":"display_value","agg":"avg","compare":"none","format":"percent","decimals":1},
      {"label":"YTD Net Profit","value_field":"display_value","agg":"sum","compare":"YTD_vs_LY","format":"currency_thousands"},
      {"label":"L12M Total","value_field":"display_value","agg":"sum","compare":"none","format":"currency_thousands"}]'::jsonb,
