...
// Column names verified from ALL_TAB_COLUMNS on MGTDAT.MGT_ITEM_CONS_STK_PO.
const oracleColumns = `MICSP_PERIOD, MICSP_ITEM_CODE, MICSP_GRADE_CODE_2,
	...
	STORES_QTY, MICSP_STR_VAL, MICSP_STR_RATE,
	DEPT_QTY, MICSP_DEPT_VAL, MICSP_DEPT_RATE,
