...
## [0.16.0](https://github.com/mutugading/goapps-backend/compare/finance-service/v0.15.0...finance-service/v0.16.0) (2026-09-26)


### Features

* **costcalc:** add RMRateOrderLoader for the GROUP-RM cascade order ([3f0001e](https://github.com/mutugading/goapps-backend/commit/3f0001ee58178b9ae5cffc2c1703c20f01d902fc))
* **costcalc:** configurable GROUP RM rate cascade and complete formula type mappings ([518207a](https://github.com/mutugading/goapps-backend/commit/518207a36b45857a99efbfeda10f5baa69557002))
* **costcalc:** migrate F_YARN_RM_RATE expression to GROUP-RM cascade config ([141edde](https://github.com/mutugading/goapps-backend/commit/141edde43a21000f49f3aa7a9a60c3fc2a7229f7))
* **costcalc:** resolve oil rate from RM group per period ([3c4efa0](https://github.com/mutugading/goapps-backend/commit/3c4efa03c3138ddf76a5cb19474b30aac3cfefe0))
* **costproducttype:** add oil class and oil group config RPCs ([284657f](https://github.com/mutugading/goapps-backend/commit/284657fb10aca1075c34a0e289d1578e93cedb4a))
* **costsheet:** show oil RM group name in exports ([71f3235](https://github.com/mutugading/goapps-backend/commit/71f323516f3cb58e29ea65362f52e61532635429))
...
* **finance:** add autofilter, sheet dimension and column widths to MB cost-calc-detail export ([f022697](https://github.com/mutugading/goapps-backend/commit/f022697ba73e42381f229d533114e6b8f1a9a617))
...
* **finance:** add migrations for oil cost by RM group (000520-000526) ([c2008f7](https://github.com/mutugading/goapps-backend/commit/c2008f7b11ca8c32be7ee764687aa8bc62800974))
* **finance:** add nested-MB flatten domain fields and graph-by-product lookup ([03a4a75](https://github.com/mutugading/goapps-backend/commit/03a4a75943f0bd5a436d1353a07b6ae3040b31bc))
...
* **finance:** compute RM_LANDED_COST via its own GROUP-RM cascade ([5c609cd](https://github.com/mutugading/goapps-backend/commit/5c609cdb5e1088b95cfa3de6529258ab3cd46b50))
* **finance:** configure F_YARN_RM_LANDED as calc-type-aware RM_LOOKUP cascade ([ea5854b](https://github.com/mutugading/goapps-backend/commit/ea5854b2ccb6aa9666ac91c8f308c81044eeef43))
...
* **finance:** enhance MB cost-calc-detail export formatting and fix all-data parameter wiring ([6715878](https://github.com/mutugading/goapps-backend/commit/6715878a2784a3a79438b66139ad429fe87936d8))
...
* **finance:** filter RM_GROUP_OIL lookup options by product type ([6848b20](https://github.com/mutugading/goapps-backend/commit/6848b201d0700bfd9602eca721e1e5bbc748b2a1))
...
* **finance:** honor shade/RM-group filters in cost sheet export job ([6533ce9](https://github.com/mutugading/goapps-backend/commit/6533ce976f7d0fcc140f8ea2d792c44ec714156e))
* **finance:** implement and wire read-time nested-MB route graph flattener ([1bce503](https://github.com/mutugading/goapps-backend/commit/1bce50372638c52225484dd659ff0e895a8af5f1))
* **finance:** implement calc-type-aware RM_LANDED_COST cascade order and computation ([6684d16](https://github.com/mutugading/goapps-backend/commit/6684d166698df257ca07f5e53c4b40f488d0fde8))
...
* **finance:** implement read-time nested-MB route graph flattener ([9b2e8c4](https://github.com/mutugading/goapps-backend/commit/9b2e8c420e2274870616b00659ae60438bc1deef))
* **finance:** improve cost result item/RM display, fix search matching, and support multi-select filters in list and export ([6fb611c](https://github.com/mutugading/goapps-backend/commit/6fb611c7a62bf2d1040c3892973961313bdfd811))
* **finance:** load RM landed-cost cascade rates and order config ([e047d75](https://github.com/mutugading/goapps-backend/commit/e047d75bde64e3da13cef1a8782c17fb981155e0))
...
* **finance:** reject OIL_NAME not allowed for product type ([6f8dd9c](https://github.com/mutugading/goapps-backend/commit/6f8dd9c351ff81166d3100cac9c82dde5d58a34e))
* **finance:** resolve item/shade/RM display on detail and breakdown views ([ea8fcce](https://github.com/mutugading/goapps-backend/commit/ea8fccec90464245608968d68e7cd1c9954b0a2a))
* **finance:** seed COST_STAGE_OUT as explicit terminal sink (000515) ([1dfd867](https://github.com/mutugading/goapps-backend/commit/1dfd86737550b9bbf5842beb0437bed202795654))
...
* **finance:** support oil cost calculation and configuration by RM group ([a020644](https://github.com/mutugading/goapps-backend/commit/a020644eada759c8288613451ee6e9d7c6f52eb6))
* **finance:** surface item, shade and raw material on cost results list ([fddbcd0](https://github.com/mutugading/goapps-backend/commit/fddbcd085d3acceb0e4efa3d3261a37b559e3eb3))
* **finance:** surface item, shade and raw material on cost results list ([602b6b8](https://github.com/mutugading/goapps-backend/commit/602b6b82daf2bf5a8c92aca7bf6200c9ec245a8e))
* **finance:** wire nested-MB flattener into GetRouteGraph, gated by flag ([9ec2646](https://github.com/mutugading/goapps-backend/commit/9ec26468008391b748e2bd3fa3d1c4104fbded03))
* **finance:** wire oil group policy and oil config repository ([597c5c4](https://github.com/mutugading/goapps-backend/commit/597c5c45d3db8d9433753771e0788d81ed084d58))
* **finance:** wire OIL_GAIN into conversion cost formulas ([b6ae405](https://github.com/mutugading/goapps-backend/commit/b6ae4055c3faf2ed6c869937a9ba5c80f7427d42))
...
* **formula:** make GROUP-RM cascade order configurable via F_YARN_RM_RATE expression ([a239484](https://github.com/mutugading/goapps-backend/commit/a239484b565fdd2a3a61c291458580e159d3f875))
* **rmgroup:** add is_oil_group flag with in-use guard ([a06ad2f](https://github.com/mutugading/goapps-backend/commit/a06ad2f63756b50b0f5d946d0c1d930af3269b15))


### Bug Fixes

* **costcalc:** cascade CR-&gt;SR-&gt;PR for GROUP-type RM cost lookup ([f9fc6a0](https://github.com/mutugading/goapps-backend/commit/f9fc6a075e9b1ad9eef68d3e18e0d8a3491ba44c))
* **finance:** add missing FK on mst_mb_head.mbh_cost_product_id (H-1) ([b859266](https://github.com/mutugading/goapps-backend/commit/b859266d214a9250f951feab8a829fcf517b247d))
...
* **finance:** cast numeric placeholders in insertNewResult to stop silent truncation ([ec13688](https://github.com/mutugading/goapps-backend/commit/ec136887461690a789e7e3dd9629467a7481aef3))
* **finance:** compute all 7 MB formulas independently per calc type ([32d4483](https://github.com/mutugading/goapps-backend/commit/32d448390e1117a37935de0713f59e2b906acf55))
* **finance:** compute all 7 MB formulas independently per calc type ([029febd](https://github.com/mutugading/goapps-backend/commit/029febda8020647674bb0e94f0aa0fd0ba0b81bb))
...
* **finance:** correct cost result list search/RM matching, add multi-select filters ([9bde1a0](https://github.com/mutugading/goapps-backend/commit/9bde1a0724b2efaab3a99bb8ce2f1d3016386545))
* **finance:** correct costing formulas, restore terminal sink, and harden test suite ([3a35063](https://github.com/mutugading/goapps-backend/commit/3a35063b776c12eea408c2aa307de626ea009fda))
...
* **finance:** exact latest-period match and single-query count in ListResults ([ce292d0](https://github.com/mutugading/goapps-backend/commit/ce292d05b26a3092dafa1dc0f2904403c6664334))
* **finance:** exact latest-period match and single-query count in ListResults ([25c14fd](https://github.com/mutugading/goapps-backend/commit/25c14fdb1dea91261f3087b1ea101197bcd078aa))
...
* **finance:** fall back to stage identity for all-data identity params ([b95baeb](https://github.com/mutugading/goapps-backend/commit/b95baeb551d70ff5aaa1d3e5da288f4b5aa20a17))
...
* **finance:** flip VBx_LOSS change-over formulas from divide to multiply ([21acc37](https://github.com/mutugading/goapps-backend/commit/21acc37e0a5ef5eef100e03731a2e739f535d1c9))
...
* **finance:** guard NULL group_head_id when scanning MB composition rows ([cbb22ce](https://github.com/mutugading/goapps-backend/commit/cbb22ce59c391d898b621e9279ecd4532a03274c))
* **finance:** make test-ci-local actually runnable and cache-proof ([4326a62](https://github.com/mutugading/goapps-backend/commit/4326a628706777b7697c4cbbb2f56c7460fc0fff))
...
* **finance:** preserve cost sheet print area and resolve product refs in MB export ([f7e42aa](https://github.com/mutugading/goapps-backend/commit/f7e42aade1c3c0a430bb07f92281207307e67391))
...
* **finance:** preserve print area when merging cost sheet workbooks ([b84249c](https://github.com/mutugading/goapps-backend/commit/b84249c8a40e9f566a9f0c7e93b84ef3c40ddd8e))
...
* **finance:** prevent product cost truncation and fix cost sheet parameter mappings ([ddaac26](https://github.com/mutugading/goapps-backend/commit/ddaac262bf4b4c4bfb603fa4fa748cde24257bbb))
* **finance:** re-backfill Group-C CAPP and CPP rows ([907a4fd](https://github.com/mutugading/goapps-backend/commit/907a4fd9750a3a31e0104ebc6c5bcf9cf0012e3f))
* **finance:** re-seed derived cost params and formulas ([6fd8223](https://github.com/mutugading/goapps-backend/commit/6fd8223501f195ecddd7d88f8d06ac6b87ae8725))
* **finance:** re-seed Group-C master data lost in production ([9c89549](https://github.com/mutugading/goapps-backend/commit/9c8954976740a1e6cc084b19b861b1ba8c6f10fc))
* **finance:** reject CALCULATED params with no active formula (D-02) ([3227595](https://github.com/mutugading/goapps-backend/commit/3227595aa0f6f6aa084a52a759b0d274e4f9c209))
...
* **finance:** resolve product code/name for MB reference routing rows ([ea2300a](https://github.com/mutugading/goapps-backend/commit/ea2300aed36e4f4355d4117d415782594074cad9))
* **finance:** resolve product code/name for MB reference routing rows ([85b822b](https://github.com/mutugading/goapps-backend/commit/85b822be52f6d994815340c9ebc2e16ec568ea9d))
* **finance:** resolve product refs to product codes in MB export ([e120706](https://github.com/mutugading/goapps-backend/commit/e120706f2871504806136ec84661fcc44ac20684))
...
* **finance:** revive unique-violation detection under the pgx driver ([5a1bed2](https://github.com/mutugading/goapps-backend/commit/5a1bed2d301305fe8d15c87aa40c27d403343ebc))
* **finance:** scope 000513/000514 zero-row guards to populated databases ([e34ca01](https://github.com/mutugading/goapps-backend/commit/e34ca01e22c4143021c2a4be292aec979293672b))
* **finance:** stop MB cost-calc-detail header fill bleeding over 11 rows ([926a096](https://github.com/mutugading/goapps-backend/commit/926a096085480f60c516f3e7bba1be0cccb69898))
...
* **finance:** use decimal duty pct in V2 integration test fixture (H-6) ([da9d779](https://github.com/mutugading/goapps-backend/commit/da9d779e296dff833560892f4b39847e444f17f1))
* **finance:** wire "98.NS SP"/"99.BC SP" to the SPECIAL_PROD params ([e725a61](https://github.com/mutugading/goapps-backend/commit/e725a61d42b4b5c9da6274062e40830202230822))
* **finance:** wire cost sheet row 81 to DELIVERY_COST_BEFORE_QLOSS ([e7f5e96](https://github.com/mutugading/goapps-backend/commit/e7f5e96eea477e8239a110be07a43ea925e0057f))
* **finance:** wire RM cascade order loaders into costcalc service ([6e97304](https://github.com/mutugading/goapps-backend/commit/6e97304eb152a65192e8afc58d8ee72175f41c0e))
* **formula:** correct stale error message on formula type validation ([5d94b2e](https://github.com/mutugading/goapps-backend/commit/5d94b2ee96e6f4d61b62e02b8f92976e3e7d18e2))
* **formula:** map all FormulaType enum values in gRPC handler ([eaa7041](https://github.com/mutugading/goapps-backend/commit/eaa70412b0fb3e1b261a6eb0d06f97c8f67e6a34))


### Performance Improvements

* **finance:** stop cost result list from scanning RM JSONB before pagination ([7737291](https://github.com/mutugading/goapps-backend/commit/77372916cfc34926422ca46184317fa74a604c6b))
* **finance:** stop cost result list from scanning RM JSONB before pagination ([56f1c6c](https://github.com/mutugading/goapps-backend/commit/56f1c6cf9761cd0509df1f211595b2f921e9dc42))
